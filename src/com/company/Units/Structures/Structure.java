...
public abstract class Structure extends Unit {
    public Structure(int health, int damage, int range, int speed, int radius, int price, double shield, double attackSpeed, PositionPair myPosition, int id, Movement movement, boolean state, Tactic myTactic) {
